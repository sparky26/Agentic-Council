...
class CivilizationalHistorianAgent(BaseAgent):
    def __init__(
        self,
        ...
        *,
        ...
        config = AgentConfig(
            name="Civilizational Historian",
            role_id="civilizational_historian",
            model_alias=model_alias,
        )
        system_prompt = get_role_system_prompt("civilizational_historian")
